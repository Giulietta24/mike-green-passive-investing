...
# -----------------------------------------------------------------------------
# PHASE 1: METRICS DISPLAY (With floating information icons)
# -----------------------------------------------------------------------------
...
with tab1:
    ...
    # Quick Summary Expander (Open by default to catch ADHD attention)
    ...
    if not df_mkt.empty:
        fig1 = go.Figure()
        # Visual color band for safe zone
        ...
        # Visual color band for high danger zone
...
with st.sidebar:
    ...
    **Where is the 83% Breaking Point?**
    ...
    st.caption("Data sources check: Live Yahoo Finance APIs and St. Louis FRED Database API endpoints.")
